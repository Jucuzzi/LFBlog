//
//  BirthdayModifyViewController.m
//  LFBlog
//
...
@interface BirthdayModifyViewController ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate>{
...
@implementation BirthdayModifyViewController
